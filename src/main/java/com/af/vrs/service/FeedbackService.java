...
import com.af.vrs.repository.FeedbackRepository;
import com.af.vrs.reservation.application.FeedbackApplicationService;

import jakarta.persistence.EntityNotFoundException;

@Service
public class FeedbackService implements FeedbackApplicationService {
    @Autowired
